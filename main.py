...
twitch_miner = TwitchChannelPointsMiner(
    ...
    password=os.getenv("TWITCH_PASSWORD"),      # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        time_zone="America/Phoenix",            # Set a specific time zone for console and file loggers. Use tz database names. Example: "America/Denver"
...
twitch_miner.mine(
    [
        Streamer("streamer-username01", settings=StreamerSettings(make_predictions=False, follow_raid=True, claim_drops=True, watch_streak=True)),
        Streamer("streamer-username01", settings=StreamerSettings(make_predictions=False, follow_raid=True, claim_drops=True, watch_streak=True)),
